...
//            cmd.Parameters.AddWithValue("@PhonePePaymentTimeUtc",
//                (object?)paymentTimeUtc ?? DBNull.Value);

//            cmd.Parameters.AddWithValue("@PhonePePaymentTimestampMs",
...
//            cmd.Parameters.AddWithValue("@RailType", (object?)railType ?? DBNull.Value);
//            cmd.Parameters.AddWithValue("@RailUTR", (object?)railUtr ?? DBNull.Value);
//            cmd.Parameters.AddWithValue("@RailUpiTransactionId", (object?)railUpiTransactionId ?? DBNull.Value);
//            cmd.Parameters.AddWithValue("@RailVPA", (object?)railVpa ?? DBNull.Value);
...
//            {
//                // keep old status, just log raw json into DB
...
//            // 🔹 New fields we actually care about (no instrument object)
...
//                // rail{ type, utr, upiTransactionId, vpa }
...
//            // 3️⃣ Update DB with everything we parsed
//            await UpdateTransactionStatusAsync(
//                merchantOrderId,
//                mappedStatus,
//                amountRupees,
...
//                // 🔹 make sure these properties exist in your DTO
